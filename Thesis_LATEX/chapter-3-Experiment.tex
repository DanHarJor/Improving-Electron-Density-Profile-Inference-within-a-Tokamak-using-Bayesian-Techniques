...
%     \item Show I am getting a local minimum of the marginal likelihood which is nice like and a lower minimum which is parabolic. This could be a result of the marginal likelihood not being a perfect loss function for problems with little data. This seems to be true for SciPy, PyTorch, stationary and non-stationary.
...
%     \item Show the stationary grid search
...
%Figure \ref{fig:trace6000} shows a trace plot for the stationary lengthscale samples from a 6000 sample chain. 
% \begin{figure}[ht]
%     \centering
