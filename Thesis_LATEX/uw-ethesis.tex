...
\input{chapter-2-background_theory.tex}
\input{chapter-3-methodology_results.tex}
\input{chapter-4-conclusion.tex}
\input{chapter-5-future_investigation.tex}
...
\input{appendix-closedformderiv.tex}
\input{appendix-margelideriv.tex}
\input{appendix-final_expressions.tex}
